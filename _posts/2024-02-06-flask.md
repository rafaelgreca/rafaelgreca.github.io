---
layout: post
title: [Notes] How to deploy a machine learning model using Flask
...
{% include figure.liquid path="assets/img/flask.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid path="assets/img/comparison-get-post.png" class="img-fluid rounded z-depth-1" %}
