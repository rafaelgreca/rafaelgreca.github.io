...
{% include figure path="assets/img/flask.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure path="assets/img/comparison-get-post.png" class="img-fluid rounded z-depth-1" %}
